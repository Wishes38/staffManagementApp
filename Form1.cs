...
namespace PersonelYonetim
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=LAPTOP-D97CNQAS\MSQLSERVER;Initial Catalog=PersonelVeriTabani;Integrated Security=True");
        void temizle()
        {
            txtad.Text = "";
            txtsoyad.Text = "";
        ...
        {
            baglanti.Open();
            SqlCommand guncelle = new SqlCommand("Update Tbl_Personel Set PerAd=@p1,PerSoyad=@p2," +
                "PerSehir=@p3,PerMaas=@p4,PerDurum=@p5,PerMeslek=@p6 where personelid=@p7",baglanti);
